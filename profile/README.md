...
OMT Global is a software portfolio focused on practical systems: home automation, self-hosted infrastructure, DevOps tooling, systems programming, and agent-assisted operations.
...
- [github-runner-fleet](https://github.com/OMT-Global/github-runner-fleet) - Self-hosted GitHub runner fleet for Synology Linux pools and ephemeral macOS runners.
- [axiom](https://github.com/OMT-Global/axiom) - Experimental, inspectable programming language with a handwritten compiler, type checker, bytecode VM, and native bootstrap path.

## Additional Public Work

- [synology-api](https://github.com/OMT-Global/synology-api) - Python wrapper around Synology APIs.
